...
namespace QuanLyBanHang
{
    public partial class FormHangHoa : Form
    {
        ...
        private void ExportExcel(string path)
        {
            ...
            // ===== 1. Thêm tiêu đề lớn =====
            worksheet.Cells[1, 1] = "Thông Tin Hàng Hóa";
            ...
            {
                worksheet.Cells[startRow, i + 1] = dataGridViewHangHoa.Columns[i].HeaderText;
            }

            // ===== 4. Xuất dữ liệu =====
            for (int i = 0; i < dataGridViewHangHoa.Rows.Count; i++)
            {
                if (dataGridViewHangHoa.Rows[i].IsNewRow) continue;
            ...
            worksheet.Range[worksheet.Cells[startRow, 1], worksheet.Cells[startRow, dataGridViewHangHoa.Columns.Count]].Font.Bold = true;
            worksheet.Range[worksheet.Cells[startRow, 1], worksheet.Cells[startRow, dataGridViewHangHoa.Columns.Count]].Interior.Color =
                System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.LightGray);

            // ===== 7. Thêm border bao quanh vùng dữ liệu =====
            int lastRow = startRow + dataGridViewHangHoa.Rows.Count - 1; // tính số dòng cuối

            Excle.Range usedRange = worksheet.Range[
     worksheet.Cells[startRow, 1],
     worksheet.Cells[lastRow, dataGridViewHangHoa.Columns.Count]
 ];
